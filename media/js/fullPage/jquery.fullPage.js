        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            requestAnimFrame(function(){
                ...
                var ind = v.sectionIndex;
                var colors=["black","#5C9AD8","#740B8E","#753234"];
                var hcolors=["#717171","#A4C6E8","#B177BF","#B18C8E"];
            
                if(ind == 0){
                    $( '.head_foot_color' ).css( 'background-color', '#717171' );
                }
                else{
                    $( '.head_foot_color' ).css( 'background-color', hcolors[ind] );
                    $(".tex button").css("background-color", "rgba(0,0,0,0)").css("color", colors[ind]);
                    $(".tex button").mouseenter(function() {
                        $(this).css("background-color", colors[ind]).css("color","white");
                    }).mouseleave(function() {
                        $(this).css("background-color", "rgba(0,0,0,0)").css("color", colors[ind]);
                    });
                }
